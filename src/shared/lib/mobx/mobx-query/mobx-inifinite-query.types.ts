...
import { MobxQueryFeatures, MobxQueryInvalidateParams, MobxQueryResetParams } from "./mobx-query.types"

export type MobxInfiniteQueryInvalidateParams = MobxQueryInvalidateParams

export type MobxInfiniteQueryResetParams = MobxQueryResetParams
...
> extends Partial<
        Omit<
            InfiniteQueryObserverOptions<TData, TError, InfiniteData<TData>, TData, TQueryKey, TPageParam>,
...
export type MobxInfiniteQueryOptions<
    ...
    TQueryKey extends QueryKey = QueryKey,
    TPageParam = unknown,
> = DefaultedInfiniteQueryObserverOptions<TData, TError, InfiniteData<TData, TPageParam>, TData, TQueryKey, TPageParam>
...
export type MobxInfiniteQueryUpdateOptions<
    ...
    TQueryKey extends QueryKey = QueryKey,
    TPageParam = unknown,
> = Partial<InfiniteQueryObserverOptions<TData, TError, InfiniteData<TData>, TData, TQueryKey, TPageParam>>
...
> extends Partial<
    ...
    onInit?: (query: MobxInfiniteQuery<TData, TError, TQueryKey, TPageParam>) => void
     ...
     */
    options?: (
        query: NoInfer<MobxInfiniteQuery<NoInfer<TData>, NoInfer<TError>, NoInfer<TQueryKey>, NoInfer<TPageParam>>>
    ) => MobxInfiniteQueryDynamicOptions<TData, TError, TQueryKey, TPageParam>
}

export type InferInfiniteQuery<
    T extends MobxInfiniteQueryConfig<any, any, any, any> | MobxInfiniteQuery<any, any, any>,
    TInferValue extends "data" | "key" | "page-param" | "error" | "query" | "config",
> =
    T extends MobxInfiniteQueryConfig<infer TData, infer TError, infer TQueryKey, infer TPageParam>
                ...
                : TInferValue extends "page-param"
                  ...
                  : TInferValue extends "error"
                    ...
                    : TInferValue extends "query"
                      ...
                      : never
        : T extends MobxInfiniteQuery<infer TData, infer TError, infer TQueryKey, infer TPageParam>
          ? TInferValue extends "config"
