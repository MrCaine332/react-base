import { DefaultError, InvalidateQueryFilters, MutationObserverOptions, QueryClient } from "@tanstack/query-core"
...
export interface MobxMutationFeatures {
     ...
     */
    invalidateByKey?: boolean | Omit<InvalidateQueryFilters, "queryKey" | "predicate">
    /**
...
export interface MobxMutationInvalidateQueriesOptions extends Omit<InvalidateQueryFilters, "queryKey"> {
    queryKey?: InvalidateQueryFilters["queryKey"]
    queryKeys?: InvalidateQueryFilters["queryKey"][]
}

export interface MobxMutationConfig<TData = unknown, TVariables = void, TError = DefaultError, TContext = unknown>
    ...
    invalidateQueries?:
        ...
        | ((data: TData, payload: TVariables) => MobxMutationInvalidateQueriesOptions)
    onInit?: (mutation: MobxMutation<TData, TVariables, TError, TContext>) => void
}
...
export type InferMutation<
    ...
    TInferValue extends "data" | "variables" | "error" | "context" | "mutation" | "config",
> =
    T extends MobxMutationConfig<infer TData, infer TVariables, infer TError, infer TContext>
                ...
                : TInferValue extends "error"
                  ...
                  : TInferValue extends "context"
                    ...
                    : TInferValue extends "mutation"
                      ...
                      : never
        : T extends MobxMutation<infer TData, infer TVariables, infer TError, infer TContext>
          ? TInferValue extends "config"
