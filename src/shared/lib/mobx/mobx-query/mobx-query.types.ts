...
export type MobxQueryInvalidateParams = Partial<Omit<InvalidateQueryFilters, "queryKey" | "exact">>

export type MobxQueryResetParams = Partial<Omit<QueryFilters, "queryKey" | "exact">>

export interface MobxQueryDynamicOptions<TData, TError = DefaultError, TQueryKey extends QueryKey = QueryKey>
    extends Partial<
        Omit<QueryObserverOptions<TData, TError, TData, TData, TQueryKey>, "queryFn" | "enabled" | "queryKeyHashFn">
    > {
    enabled?: boolean
}
...
> = DefaultedQueryObserverOptions<TData, TError, TData, TData, TQueryKey>

export type MobxQueryUpdateOptions<TData, TError = DefaultError, TQueryKey extends QueryKey = QueryKey> = Partial<
...
export type MobxQueryConfigFromFn<
    ...
    TError = DefaultError,
    TQueryKey extends QueryKey = QueryKey,
> = MobxQueryConfig<ReturnType<T> extends Promise<infer TData> ? TData : ReturnType<T>, TError, TQueryKey>

export interface MobxQueryConfig<TData, TError = DefaultError, TQueryKey extends QueryKey = QueryKey>
    extends Partial<Omit<QueryObserverOptions<TData, TError, TData, TData, TQueryKey>, "queryKey">>,
        MobxQueryFeatures {
     ...
     */
    options?: (
        query: NoInfer<MobxQuery<NoInfer<TData>, NoInfer<TError>, NoInfer<TQueryKey>>>
    ) => MobxQueryDynamicOptions<TData, TError, TQueryKey>
}

export type MobxQueryFn<TData, TError = DefaultError, TQueryKey extends QueryKey = QueryKey> = Exclude<
    MobxQueryConfig<TData, TError, TQueryKey>["queryFn"],
    undefined
>

export interface MobxQueryStartParams<TData, TError = DefaultError, TQueryKey extends QueryKey = QueryKey>
