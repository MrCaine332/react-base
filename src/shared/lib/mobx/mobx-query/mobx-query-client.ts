...
import { MobxQueryClientConfig, MobxQueryClientHooks } from "./mobx-query-client.types"
...
export class MobxQueryClient extends QueryClient {
    ...
    setDefaultOptions(options: Exclude<MobxQueryClientConfig["defaultOptions"], undefined>): void {
        super.setDefaultOptions(options)
        this.config.defaultOptions = options
    }

    getDefaultOptions(): Exclude<MobxQueryClientConfig["defaultOptions"], undefined> {
