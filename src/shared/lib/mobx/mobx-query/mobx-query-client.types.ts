import { DefaultError, DefaultOptions, QueryClient, QueryClientConfig } from "@tanstack/query-core"
...
export type QueryClientInterface = {
    [K in keyof QueryClient]: QueryClient[K] extends Function ? QueryClient[K] : never
}
...
export interface MobxQueryClientHooks {
    ...
    onInfiniteQueryDestroy?: (query: MobxInfiniteQuery<any, any, any, any>) => void
    onMutationDestroy?: (query: MobxMutation<any, any, any, any>) => void
}

export interface MobxQueryClientConfig extends Omit<QueryClientConfig, "defaultOptions"> {
